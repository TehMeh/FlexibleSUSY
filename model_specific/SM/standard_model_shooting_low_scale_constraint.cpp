...
Standard_model_low_scale_constraint<Shooting>::Standard_model_low_scale_constraint(
   StandardModel<Shooting>* model_, const softsusy::QedQcd& qedqcd_)
...
void Standard_model_low_scale_constraint<Shooting>::apply()
{
   if (!model)
...
double Standard_model_low_scale_constraint<Shooting>::get_scale() const
{
   return scale;
}

void Standard_model_low_scale_constraint<Shooting>::set_model(Model* model_)
{
   model = cast_model<StandardModel<Shooting>*>(model_);
}

void Standard_model_low_scale_constraint<Shooting>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& Standard_model_low_scale_constraint<Shooting>::get_sm_parameters() const
{
   return qedqcd;
}

void Standard_model_low_scale_constraint<Shooting>::clear()
{
   scale = 0.;
   model = nullptr;
...
void Standard_model_low_scale_constraint<Shooting>::initialize()
{
